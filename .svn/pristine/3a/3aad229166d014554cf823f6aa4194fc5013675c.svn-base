...
module.exports.routes = {
    ...
    'GET /movementDetected/:state': {
        controller: 'IndexController',
        action: 'movementDetected'
    },
    'GET /public/birdimage/*': {
    ...
    'GET /backup/photo': {
        controller: 'SettingsController',
        action: 'startBackupPhoto'
    },
    'GET /backup/video': {
        controller: 'SettingsController',
        action: 'startBackupVideo'
    },
    'GET /settings/toggleDetectionState/:state': {
        controller: 'SettingsController',
        action: 'toggleDetectionState'
    }
  /*
